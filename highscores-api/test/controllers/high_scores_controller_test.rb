...
class HighScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create high_score" do
    assert_difference("HighScore.count") do
      post high_scores_url, params: { high_score: { game: @high_score.game, name: @high_score.name, score: @high_score.score } }, as: :json
    end
  ...
  test "should update high_score" do
    patch high_score_url(@high_score), params: { high_score: { game: @high_score.game, name: @high_score.name, score: @high_score.score } }, as: :json
    assert_response :success
  end
